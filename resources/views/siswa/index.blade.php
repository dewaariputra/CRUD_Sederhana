                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($siswa as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/siswa/' . $item->id) }}" title="View Siswa" class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                            <a href="{{ url('/siswa/' . $item->id . '/edit') }}" title="Edit Siswa" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
